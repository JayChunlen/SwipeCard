...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (self.isPresenting) {
        ...
        toVC.view.transform = CGAffineTransformScale(xForm, 1.0f, 1.0f);
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext]
                         animations:^{
                             ...
                             CGAffineTransformScale(fromVC.view.transform, 1.f, 1.f);
                         }
        ...
        CGAffineTransform xForm = toVC.view.transform;
        toVC.view.transform = CGAffineTransformScale(toVC.view.transform, 1.f, 1.f);
